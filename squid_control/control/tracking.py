import squid_control.control.utils_.image_processing as image_processing
import numpy as np
...
try:
	...
	print(2) 
	from squid_control.control.DaSiamRPN.code.utils import get_axis_aligned_bbox, cxy_wh_2_rect
	print(3)
	from squid_control.control.DaSiamRPN.code.run_SiamRPN import SiamRPN_init, SiamRPN_track
	print(4)
except Exception as e:
	print(e)
	# print('Warning: DaSiamRPN is not available!')
from squid_control.control._def import Tracking
import cv2
